...
def main():
    ...
    parser.add_argument('--triple_sample', default=False, action="store_true", help='use triple_sample for ensemble')
    parser.add_argument('--five_sample', default=False, action="store_true", help='use five_sample for ensemble')
    parser.add_argument('--ten_sample', default=False, action="store_true", help='use ten_sample for ensemble')
    ...
    def eval_video(video_data, net, this_test_segments, modality):
        ...
        with torch.no_grad():
            ...
            if is_shift:
                data_in = data_in.view(batch_size * num_crop, this_test_segments, length, data_in.size(2),
                                       data_in.size(3))
            rst = net(data_in)
